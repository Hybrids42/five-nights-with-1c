...
Процедура НачатьИгру(Отправитель)
	...
	ДанныеКартинки = Вопрос.Картинка.Получить();
	...
	Иначе
		ИнтеграцияТелеграм.ОтправитьКартинку(Отправитель, ДанныеКартинки, Вопрос.Текст, ДополнительныеСвойства);
	КонецЕсли;
...
Процедура ОбработатьНажатиеКнопки(НажатиеКнопки)
	...
	Иначе
		ИнтеграцияТелеграм.ОтправитьКартинку(Получатель, ДанныеКартинки, Вопрос.Текст, ДополнительныеСвойства);
	КонецЕсли;
